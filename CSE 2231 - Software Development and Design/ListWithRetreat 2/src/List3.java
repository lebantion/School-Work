...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        this.lastLeft.next = rightNode;
        rightNode.next = nextNode;
        rightNode.previous = this.lastLeft;
        nextNode.previous = rightNode;
    ...
    public final T removeRightFront() {
        ...
        Node rightNode = this.lastLeft.next;
        T returnData = rightNode.data;
        
        Node rightNextNode = rightNode.next;
        rightNextNode.previous = this.lastLeft;
        
        this.lastLeft.next = rightNextNode;
        this.rightLength--;
